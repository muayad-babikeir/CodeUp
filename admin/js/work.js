...
async function openReviewModal(sub){
  ...
  const m = Admin.modal(`
    ...
    ${sub.github_url ? `<div class="card2" style="margin-bottom:10px"><a href="${CodeUp.escapeHtml(sub.github_url)}" target="_blank" rel="noopener noreferrer" class="btn dark" style="display:inline-flex;align-items:center"><span class="inlineBtnIcon">${Icon("link")}</span> فتح رابط GitHub</a></div>` : ""}
